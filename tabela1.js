function veracertos(){
  ...
  if (valor_entrada_input0==(1*0)&&valor_entrada_input1==(1*1)&&valor_entrada_input2==(1*2)&&valor_entrada_input3==(1*3)&&valor_entrada_input4==(1*4)&&valor_entrada_input5==(1*5)&&valor_entrada_input6==(1*6)&&valor_entrada_input7==(1*7)&&valor_entrada_input8==(1*8)&&valor_entrada_input9==(1*9)&&valor_entrada_input10==(1*10)){
  ...
  else if (valor_entrada_input0!=(1*0)||valor_entrada_input1!=(1*1)||valor_entrada_input2!=(1*2)||valor_entrada_input3!=(1*3)||valor_entrada_input4!=(1*4)||valor_entrada_input5!=(1*5)||valor_entrada_input6!=(1*6)||valor_entrada_input7!=(1*7)||valor_entrada_input8!=(1*8)||valor_entrada_input9!=(1*9)||valor_entrada_input10!=(1*10)){
...
function mouseOver11(){
    document.getElementById('area9').style.background="#C0C0C0";
   
  }
  
  function mouseOut11(){
   document.getElementById('area9').style.background="rgb(240, 233, 233)";
   
  }
  function clicar11(){
   document.getElementById('area9').style.background="#808080";
  }
  ////////////////////////////////////////////////////////////////////////////
  function mouseOver12(){
    document.getElementById('area10').style.background="#C0C0C0";
   
  }
  
  function mouseOut12(){
   document.getElementById('area10').style.background="rgb(240, 233, 233)";
   
  }
  function clicar12(){
   document.getElementById('area10').style.background="#808080";
  }